...
/**
 * Pure catalog data for optional document capability packs — no electron or
 * runtime dependencies, so both the install mechanism (`document-packs.js`) and
 * the offline build script (`scripts/build-document-pack.mjs`) share one source
