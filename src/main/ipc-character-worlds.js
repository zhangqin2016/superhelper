...
function registerCharacterWorldsHandlers(ctx) {
  ...
  require("./official-context-ipc").registerOfficialContextHandlers({ ipcMain, ctx, guard, failure, mapDomainError, policyDeniesSelection, resolveOwnerScope, repository });
