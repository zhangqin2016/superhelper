...
const { progressValueFromNotice, shouldBeginTaskRunAtTurnStart, compactTool, createLeadLeaseRenewal } = require("./task-run-runtime-support");
...
function createTaskRunRuntime(options = {}) {
  ...
  const renewLeadLease = createLeadLeaseRenewal({ agentTaskGraphStore, now, log });
