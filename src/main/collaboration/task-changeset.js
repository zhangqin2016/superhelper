...
function taskChangeset({baseManifest,manifest,materializedPaths}) {
  ...
  // Only an unambiguous identical-content move establishes rename identity.
  // Ambiguous/edited moves remain explicit delete+add, never guessed intent.
