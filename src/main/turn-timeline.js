...
// Text/thinking block formation is shared with the renderer so the turn that
// is archived and the turn that is drawn cannot disagree about its blocks.
const {
  appendTimelineText,
...
} = require("../shared/timeline-blocks.mjs");
