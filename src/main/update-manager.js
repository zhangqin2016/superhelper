...
function createBaseState() {
  return {
    ...
    notes: "",
    force: false,
    requiredVersion: "", requiredReason: "", mandateDeadline: "",
    enforcement: null,
    feedUrl: "",
...
async function checkStaticUpdates() {
  ...
  return {
    ...
    ...require("./update-enforcement").requirementOf(manifest),
...
async function checkServiceUpdates() {
  ...
  return {
    ...
    ...require("./update-enforcement").requirementOf(release),
    notes: release.notes || "",
    platformKey,
    source: "service",
...
async function checkForUpdatesState() {
  ...
  const next = {
    ...
    ...require("./update-enforcement").requirementOf(result),
    feedUrl,
