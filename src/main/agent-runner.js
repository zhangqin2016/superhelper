...
const ERROR_PATTERNS = [
  ...
  },
  {
    ...
    category: "model",
    test: new RegExp(`API Error:|Connection to the model service was interrupted|model service .*interrupted|${net.TRANSIENT_NETWORK_SIGNATURE}|timed? out|timeout|502|503|504|500\\b|Internal Server Error|bad gateway|gateway time?out|upstream.*error|backend.*error|aborted|request.*failed|connection.*refused|connection.*reset|SSL|TLS|certificate|DNS`, "i"),
