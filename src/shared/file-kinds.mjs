...
const TABLE = {
  ...
  ".docm": { kind: "document", mime: "application/vnd.ms-word.document.macroEnabled.12", ooxml: true },
  ...
  ".pptm": { kind: "presentation", mime: "application/vnd.ms-powerpoint.presentation.macroEnabled.12", ooxml: true },
