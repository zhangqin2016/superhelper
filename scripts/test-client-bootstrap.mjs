...
assert.equal(
  resolveClientRegion({ headers: { host: "lilyxinjiapo.lilywb.cn" } }),
  "uae",
...
assert.equal(uae.apiBaseUrl, "https://lilyxinjiapo.lilywb.cn");
assert.equal(uae.gatewayBaseUrl, "https://lilyxinjiapo.lilywb.cn");
assert.equal(uae.modelGatewayBaseUrl, "https://lilyxinjiapo.lilywb.cn/llm");
...
assert.equal(clientFeatureEnabled({ headers: { host: "lilyxinjiapo.lilywb.cn" } }, "accountLogin"), false);
assert.equal(clientFeatureEnabled({ headers: { host: "lilyxinjiapo.lilywb.cn" } }, "purchase"), false);
