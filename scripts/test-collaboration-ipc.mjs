...
assert.deepEqual(await handlers.get("collaboration:open")(null, { conversationId: "c1" }), { ok: true, conversation: { id: "c1", scopeId: "", kind: "", title: "Safe", updatedAt: 0, lastSeq: null }, messages: [{ id: "m1", conversationId: "c1", seq: null, senderUserId: "", state: "", bodyText: "hi", kind: "text", attachmentIds: [], createdAt: null, clientCreatedAt: null, updatedAt: 0, replyToMessageId: null, mentionUserIds: [] }], hasMore: false, nextBeforeSeq: null, offline: false });
...
assert.deepEqual(calls, [{ conversationId: "c1", clientCommandId: "cmd-1", bodyText: "Hello", replyToMessageId: null, mentionUserIds: [] }]);
