...
assert.equal(rendererSanitizeNoticeForIngest({ code: "longWait", level: "progress", panel: true }).panel, true);
assert.equal(rendererSanitizeNoticeForIngest({ code: "toolProgress", level: "progress", panel: true, detail: "uploaded 42%" }).panel, true);
