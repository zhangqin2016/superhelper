...
|---|---|
| `AUTH_REQUIRED` | `MC-ERR-AUTH-REQUIRED` |
| `ACCOUNT_NOT_ALLOWED` | `MC-ERR-AUTH-ACCOUNT-NOT-ALLOWED` |
| `FEATURE_DISABLED` | `MC-ERR-CONFIG-FEATURE-DISABLED` |
| `CONFIG_UNAVAILABLE` | `MC-ERR-CONFIG-UNAVAILABLE` |
| `PAIRING_TOKEN_EXPIRED` | `MC-ERR-PAIRING-TOKEN-EXPIRED` |
| `PAIRING_TOKEN_CONSUMED` | `MC-ERR-PAIRING-TOKEN-CONSUMED` |
| `PAIRING_TOKEN_INVALID` | `MC-ERR-PAIRING-TOKEN-INVALID` |
| `PAIRING_DESKTOP_OFFLINE` | `MC-ERR-PAIRING-DESKTOP-OFFLINE` |
| `PAIRING_DESKTOP_REJECTED` | `MC-ERR-PAIRING-DESKTOP-REJECTED` |
| `DEVICE_NOT_FOUND` | `MC-ERR-AUTH-DEVICE-NOT-FOUND` |
| `DEVICE_REVOKED` | `MC-ERR-AUTH-DEVICE-REVOKED` |
| `DEVICE_SIGNATURE_INVALID` | `MC-ERR-AUTH-SIGNATURE-INVALID` |
| `DEVICE_KEY_ROTATION_REQUIRED` | `MC-ERR-AUTH-KEY-ROTATION-REQUIRED` |
| `REMOTE_SESSION_NOT_FOUND` | `MC-ERR-SESSION-NOT-FOUND` |
| `REMOTE_SESSION_EXPIRED` | `MC-ERR-SESSION-EXPIRED` |
| `REMOTE_SESSION_CONFLICT` | `MC-ERR-SESSION-CONFLICT` |
| `REMOTE_SESSION_STALE` | `MC-ERR-SESSION-STALE` |
| `REMOTE_SESSION_ENDED` | `MC-ERR-SESSION-ENDED` |
| `PERMISSION_DENIED` | `MC-ERR-PERMISSION-DENIED` |
| `PERMISSION_APPROVAL_REQUIRED` | `MC-ERR-PERMISSION-APPROVAL-REQUIRED` |
| `PERMISSION_APPROVAL_EXPIRED` | `MC-ERR-PERMISSION-APPROVAL-EXPIRED` |
| `PERMISSION_POLICY_FAILED` | `MC-ERR-PERMISSION-POLICY-FAILED` |
| `AGENT_SESSION_NOT_FOUND` | `MC-ERR-BRIDGE-SESSION-ABSENT` |
| `AGENT_BRIDGE_BUSY` | `MC-ERR-BRIDGE-BUSY` |
| `AGENT_BRIDGE_FAILED` | `MC-ERR-BRIDGE-INJECTION-FAILED` |
| `AGENT_MESSAGE_DUPLICATE` | `MC-ERR-BRIDGE-DUPLICATE` |
| `WEBRTC_SIGNALING_FAILED` | `MC-ERR-WEBRTC-SIGNALING-FAILED` |
| `WEBRTC_TURN_UNAVAILABLE` | `MC-ERR-WEBRTC-TURN-UNAVAILABLE` |
| `WEBRTC_ICE_FAILED` | `MC-ERR-WEBRTC-ICE-FAILED` |
| `WEBRTC_DATA_CHANNEL_CLOSED` | `MC-ERR-WEBRTC-DATA-CHANNEL-CLOSED` |
| `WEBRTC_SOURCE_UNAVAILABLE` | `MC-ERR-WEBRTC-SOURCE-UNAVAILABLE` |
| `INPUT_NOT_AUTHORIZED` | `MC-ERR-INPUT-NOT-AUTHORIZED` |
| `INPUT_INJECTION_FAILED` | `MC-ERR-INPUT-INJECTION-FAILED` |
| `SCREEN_CAPTURE_PERMISSION_MISSING` | `MC-ERR-INPUT-CAPTURE-PERMISSION-MISSING` |
| `SCREEN_SOURCE_CHANGED` | `MC-ERR-INPUT-SOURCE-CHANGED` |
| `UPLOAD_TOO_LARGE` | `MC-ERR-UPLOAD-TOO-LARGE` |
| `UPLOAD_QUOTA_EXCEEDED` | `MC-ERR-UPLOAD-QUOTA-EXCEEDED` |
| `UPLOAD_CHUNK_MISSING` | `MC-ERR-UPLOAD-CHUNK-MISSING` |
| `UPLOAD_CHUNK_HASH_MISMATCH` | `MC-ERR-UPLOAD-CHUNK-HASH-MISMATCH` |
| `UPLOAD_FILE_HASH_MISMATCH` | `MC-ERR-UPLOAD-FILE-HASH-MISMATCH` |
| `UPLOAD_EXPIRED` | `MC-ERR-UPLOAD-EXPIRED` |
| `UPLOAD_DESKTOP_PULL_FAILED` | `MC-ERR-UPLOAD-DESKTOP-PULL-FAILED` |
| `UPLOAD_STAGING_FAILED` | `MC-ERR-UPLOAD-STAGING-FAILED` |
| `UPLOAD_RISK_APPROVAL_REQUIRED` | `MC-ERR-UPLOAD-RISK-APPROVAL-REQUIRED` |
| `ARTIFACT_NOT_FOUND` | `MC-ERR-ARTIFACT-NOT-FOUND` |
| `ARTIFACT_EXPIRED` | `MC-ERR-ARTIFACT-EXPIRED` |
| `ARTIFACT_DOWNLOAD_DENIED` | `MC-ERR-ARTIFACT-DOWNLOAD-DENIED` |
| `REQUEST_INVALID` | `MC-ERR-PROTOCOL-INVALID` |
| `REQUEST_CLOCK_SKEW` | `MC-ERR-AUTH-CLOCK-SKEW` |
| `REQUEST_REPLAY_DETECTED` | `MC-ERR-AUTH-REPLAY-DETECTED` |
| `REQUEST_IDEMPOTENCY_CONFLICT` | `MC-ERR-PROTOCOL-IDEMPOTENCY-CONFLICT` |
| `SERVER_RATE_LIMITED` | `MC-ERR-SERVER-RATE-LIMITED` |
| `SERVER_UNAVAILABLE` | `MC-ERR-SERVER-UNAVAILABLE` |

This table is exhaustive for accepted protocol aliases. Each alias has exactly one target; no prefix/closest-code inference is allowed. New implementations emit only canonical codes.
...
`ApprovalDecisionPayload` is accepted only by desktop local IPC. Mobile wire clients may submit an approval request and observe `ApprovalProjection`; no mobile endpoint/event accepts `allow_once`, `allow_timed`, `granted`, or `denied` as an authorizing decision. A remotely eligible non-authorizing runtime prompt uses distinct `user_question.answer` bridge semantics and never MC-SM-APPROVAL.
