...
| MC-SPEC-003 | `mobile-command-requirements-traceability.md` (planned) | Requirement-to-contract-to-owner-to-test-to-release coverage | MC-SPEC-005, MC-SPEC-008–017, MC-SPEC-019–030 | draft | [Task 9 traceability and readiness](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-9-build-requirements-traceability-and-release-readiness-gates) |
| MC-SPEC-004 | `mobile-command-release-readiness-checklist.md` (planned) | Specification-freeze authorization and later release sign-off | MC-SPEC-002–003, MC-SPEC-005–030, MC-SPEC-037–038 | draft | [Task 9 readiness gates](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-9-build-requirements-traceability-and-release-readiness-gates); [Task 11 final freeze](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-11-final-specification-freeze-review) |
...
| MC-SPEC-015 | `mobile-command-platform-support-matrix.md` (planned) | Supported level and explicit degradation for every desktop/mobile platform pair | MC-SPEC-016–019, MC-ADR-004–008 | evidence-needed | [Task 7 platform evidence](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-7-resolve-platform-os-helper-asr-and-visual-decisions) |
| MC-SPEC-016 | `mobile-command-os-helper-decision.md` (planned) | Proven OS capture/input helpers, IPC, permissions, signing, packaging, and recovery | MC-SPEC-018–019, MC-ADR-005–007 | evidence-needed | [Task 7 platform evidence](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-7-resolve-platform-os-helper-asr-and-visual-decisions) |
| MC-SPEC-017 | `mobile-command-asr-decision.md` (planned) | Proven ASR primary/fallback, latency, quality, cost, privacy, and credentials | MC-SPEC-020–021, MC-ADR-008 | evidence-needed | [Task 7 ASR evidence](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-7-resolve-platform-os-helper-asr-and-visual-decisions) |
...
| MC-SPEC-022 | `mobile-command-visual-design-system.md` (planned) | Brand-derived tokens, layouts, states, safe areas, dark mode, and visual QA references | MC-SPEC-031–033 | evidence-needed | [Task 7 visual evidence](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-7-resolve-platform-os-helper-asr-and-visual-decisions) |
| MC-SPEC-023 | `mobile-command-infrastructure-deployment.md` (planned) | Signaling, TURN, storage, push, TLS, secrets, capacity, cost, backup, and DR topology | MC-SPEC-005–014, MC-ADR-004, MC-ADR-009–010 | evidence-needed | [Task 8 infrastructure](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-8-freeze-infrastructure-privacy-observability-and-support) |
| MC-SPEC-024 | `mobile-command-privacy-retention-compliance.md` (planned) | Data inventory, prohibitions, redaction, retention, deletion, EXIF, consent, and privacy copy | MC-SPEC-006–010, MC-SPEC-017, MC-SPEC-023 | evidence-needed | [Task 8 privacy](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-8-freeze-infrastructure-privacy-observability-and-support) |
| MC-SPEC-025 | `mobile-command-observability-support.md` (planned) | Telemetry schema, metrics, alerts, diagnostics, dashboards, and support workflows | MC-SPEC-010–011, MC-SPEC-023–024 | evidence-needed | [Task 8 observability/support](superpowers/plans/2026-07-12-mobile-command-specification-closure.md#task-8-freeze-infrastructure-privacy-observability-and-support) |
