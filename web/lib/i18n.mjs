    ...
    admin: {
      ...
      attention: {
        ...
        items: {
          ...
          fleetBelowRequired: "本周活跃但低于强制版本的设备",
        },
        fleet: "在用设备",
        installed: "累计安装 {n}",
        activeWithin: "{w} 内活跃",
      ...
      rollouts: { support: "支持策略", minimum: "最低支持版本", noMinimum: "未设最低支持版本", belowMinimum: "低于它的活跃设备 {n} 台", blocked: "已拉黑", blockedList: "拉黑的版本（逗号分隔）", deadline: "强制更新截止时间", deadlineShort: "截止", supportHelp: "低于最低支持版本的客户端必须更新；拉黑的版本不再提供，装了它的客户端在有更新版本时必须更新（不会降级）；截止时间后不能再推迟。留空即不设。", saveSupport: "保存支持策略", markMinimum: "设为最低支持版本", markMinimumConfirm: "把 {version} 设为 {platform} 的最低支持版本？所有低于它的客户端会在空闲时倒计时重启更新。", block: "拉黑", unblock: "取消拉黑", blockConfirm: "拉黑 {platform} 的 {version}？不再提供给任何设备；已装它的设备在有更新版本时必须更新。", newRelease: "新增版本", refused: "操作未执行", everyone: "所有设备获得", activeWeek: "本周活跃 {n} 台", installed: "已装 {n} 台", notStarted: "尚未推送", startAt: "起始比例", start: "开始推送", noOwnFeed: "此版本没有独立更新文件，只能全量", nothingPending: "没有进行中的发布", widenTo: "扩大到 {n}%", pause: "暂停", resume: "继续", halt: "中止", reopen: "重新打开", complete: "完成（全量）", completeConfirm: "把 {platform} 的 {version} 推送给所有设备？完成后请运行 npm run release:promote 推进兜底更新源。", haltConfirm: "中止 {platform} 的 {version}？不再推送给任何新设备，已装的不受影响。", healthCompare: "错误率 {rate}/台，上一版 {baseline} 为 {base}/台", healthWorse: "比上一版差", healthVerdict: { insufficient: "健康：活跃设备还太少", no_baseline: "健康：没有可比较的上一版" }, states: { draft: "草稿", rolling: "灰度中", paused: "已暂停", halted: "已中止", complete: "已全量" } },
    ...
    admin: {
      ...
      attention: {
        ...
        items: {
          ...
          fleetBelowRequired: "Active devices below a mandatory release",
        },
