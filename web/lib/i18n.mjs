...
export const dictionaries = {
  ...
  en: {
    ...
    admin: {
      ...
      rollouts: { newRelease: "New release", refused: "Not done", everyone: "Everyone gets", activeWeek: "{n} active this week", installed: "{n} installed", notStarted: "not offered yet", startAt: "Start at", start: "Start rollout", noOwnFeed: "no own update feed: full release only", nothingPending: "No rollout in progress", widenTo: "Widen to {n}%", pause: "Pause", resume: "Resume", halt: "Halt", reopen: "Reopen", complete: "Complete (everyone)", completeConfirm: "Offer {version} on {platform} to every device? Afterwards run npm run release:promote to move the fallback feeds.", haltConfirm: "Halt {version} on {platform}? No new device is offered it; installed ones are unaffected.", healthCompare: "{rate} errors/device vs {base} on {baseline}", healthWorse: "worse than the previous version", healthVerdict: { insufficient: "Health: too few active devices yet", no_baseline: "Health: no comparable previous version" }, states: { draft: "Draft", rolling: "Rolling", paused: "Paused", halted: "Halted", complete: "Complete" } },
