// COPY of src/shared/committed-message-order.mjs — the web app cannot import
// outside web/, so the phone carries the same text; test-mobile-conversation-view
// holds the two byte-identical after this header.
