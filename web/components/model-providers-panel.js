...
const labels = {
  zh: {
    ...
    defaultTag: "默认",
    nativeVision: "支持截图 / 图片理解",
    nativeVisionHelp: "这个供应商下的模型能直接理解 UI 截图、照片、图表时才勾。勾选后客户端可直接把图片发给该模型。",
    modelCount: "模型数",
    save: "保存供应商",
    keySet: "已设密钥",
    noKey: "未设密钥",
  ...
  en: {
    ...
    defaultTag: "Default",
    nativeVision: "Understands screenshots / images",
    nativeVisionHelp: "Only enable this when models under this provider can directly understand UI screenshots, photos, or charts.",
    modelCount: "Models",
    save: "Save provider",
    keySet: "key set",
    noKey: "no key",
  ...
  ar: {
    ...
    defaultTag: "افتراضي",
    nativeVision: "يفهم لقطات الشاشة / الصور",
    nativeVisionHelp: "فعّله فقط إذا كانت نماذج هذا المزوّد تفهم لقطات واجهة المستخدم أو الصور أو المخططات مباشرة.",
