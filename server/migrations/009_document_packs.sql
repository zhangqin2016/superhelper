-- Optional document capability packs (e.g. the pro-pdf Docling engine).
...
create index if not exists document_packs_lookup
  on document_packs (pack_id, platform, enabled);
