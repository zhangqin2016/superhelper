...
export const OPENAPI_TAGS = [
  ...
  { name: "public:legal-knowledge-packs", description: "Authorized legal knowledge pack artifacts" },
  ...
  { name: "public:agents", description: "Public agent (智能体) registry" },
  ...
  { name: "admin:enterprise", description: "Admin enterprise organization governance" },
  { name: "admin:releases", description: "Admin app releases" },
  { name: "admin:runtime-packs", description: "Admin runtime packs" },
  { name: "admin:legal-knowledge-packs", description: "Admin legal knowledge pack releases" },
  { name: "admin:skill-packages", description: "Admin skill packages" },
  { name: "admin:agent-packages", description: "Admin agent (智能体) packages" },
