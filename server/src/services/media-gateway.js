...
// The self-hosted GPU media integration lived here until 2026-09-23: its own
// kinds, voice table, URL builders, asset proxy and token audience, roughly 230
// lines no other provider needed. Its endpoints are gone, and an integration
// that needs a private path through five files is not one anyone can repeat —
// every media provider now goes through the generic /llm/media/:provider route
// with a credential row and a catalog entry.
