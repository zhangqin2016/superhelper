...
import { registerAdminLegalKnowledgePackRoutes } from "./admin/legal-knowledge-packs.js";
...
import { registerAdminReleaseSupportRoutes, registerAdminRolloutRoutes } from "./admin/rollouts.js";
...
import { registerAdminAgentPackageRoutes } from "./admin/agent-packages.js";
...
export async function adminRoutes(app) {
  ...
  registerAdminAgentPackageRoutes(app, { audit });
