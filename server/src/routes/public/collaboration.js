...
function receiptAuthorizationError(decision) { const error = new Error(decision?.auditReason || "receipt authorization denied"); error.code = decision?.code || "COLLAB_AUTHORIZATION_DENIED"; return error; }
